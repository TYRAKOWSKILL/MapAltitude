...
function setElevation(stringGeoLoc) {
    var url= 'http://open.mapquestapi.com/elevation/v1/chart?key=YCkvK78NdGpW7eQx5LwDX5inOZHxUUsb&shapeFormat=raw&width=800&height=800&latLngCollection='+ stringGeoLoc;
    fetch(url)
